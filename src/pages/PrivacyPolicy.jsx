  ...
  return (
    <Container>
      <div className="text-center py-10">
        ...
        <p>
          This website is operated by Divine Perfumers. Throughout the site, the
          terms “we”, “us” and “our” refer to Divine Perfumers. Divine Perfumers
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 1 - ONLINE STORE TERMS</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 2 - GENERAL CONDITIONS</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 7 - OPTIONAL TOOLS</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 8 - THIRD-PARTY LINKS</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 10 - PERSONAL INFORMATION</h2>
        <p>
          Your submission of personal information through the store is governed
          by our Privacy Policy. To view our Privacy Policy.
        </p>

        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 12 - PROHIBITED USES</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
        <p>
        ...
        <p>
          In no case shall Divine Perfumers, our directors, officers, employees,
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 14 - INDEMNIFICATION</h2>
        <p>
          You agree to indemnify, defend and hold harmless Divine Perfumers and
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 15 - SEVERABILITY</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 16 - TERMINATION</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 17 - ENTIRE AGREEMENT</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 18 - GOVERNING LAW</h2>
        <p>
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of Country, State/Province, Postal Code, governing law without
          regard to its conflict of law provisions.
        </p>

        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
        <p>
        ...
        <h2 className='text-2xl font-semibold mt-8 mb-2'>SECTION 20 - CONTACT INFORMATION</h2>
        <p>
          Questions about the Terms of Service should be sent to us at
          contact@divineperfumers.com.
        </p>
      </div>
    </Container>
  );
